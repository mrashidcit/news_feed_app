...
/**
 * Created by Rashid Saleem on 23-Dec-17.
 */
...
public final class  QueryUtils {
    ...
    public static List<Article> fetchArticleData(String requestUrl) {
        ...
        // Perform HTTP request to the URL and reeive a JSON response back
        ...
        // Extrac relevant fields from the JSON response and create a list of {@link Article}s
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            // thren read the input stream and parse the response
    ...
    private static List<Article> extractArticleFromJson(String articleJSON) {
        ...
        try {
            ...
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                // Get a single article at position within the list of articles
                ...
                // Create a new {@link Article} object with the author, title, description
